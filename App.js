...
const MainFlow = () => {
  return (
    <Bottom.Navigator>
      <Bottom.Screen component={TrackListFlow} name="Track List" options={{ headerShown: false }}></Bottom.Screen>
      <Bottom.Screen component={TrackCreateScreen} options={{ headerShown: false }} name="Add Tracks"></Bottom.Screen>
      <Bottom.Screen component={AccountScreen} options={{ headerShown: false }} name="Log Out"></Bottom.Screen>
    </Bottom.Navigator>
  );
};
